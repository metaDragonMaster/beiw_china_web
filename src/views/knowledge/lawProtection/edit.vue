<template>
	<div class="limit-max-width view">
		<el-card>
			<el-form ref="Form" :model="Form" :rules="Rules" inline label-position="right" label-width="7rem">
				<h1 class="form-type-title">知识产权法律维权资讯表单</h1>
				...
				<el-form-item prop="enterpriseName" label="机构企业名称"><el-input v-model="Form.enterpriseName"></el-input></el-form-item>
				<h1 class="form-type-title">上传封面</h1>
					<el-form-item prop="image" label="图片"><uploadImg ref="UploadImg" moduleName="web" v-model="Form.image"></uploadImg></el-form-item>
				<h1 class="form-type-title">编辑内容</h1>
				<el-form-item prop="enterpriseDetails" label="机构简介">
			...
			this.$refs['Form'].validate(async valid => {
				if (valid) {
					...
					if (code == 10200) {
						...
						this.$confirm('上传成功，是否进入知识产权法律维权服务?', '提示', {
							confirmButtonText: '确定',
							cancelButtonText: '取消',
							type: 'success'
						}).then(() => {
							this.$routerUtil.toPath('/knowledge/lawProtection');
						});
					} else {
