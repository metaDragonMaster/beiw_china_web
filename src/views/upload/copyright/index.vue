	...
	<div class="limit-max-width view">
		<el-card>
			<el-form ref="Form" :model="Form" :rules="Rules" label-width="6rem" inline>
				<h1 class="form-type-title">版权详情</h1>
				<el-form-item prop="name" label="版权名称"><el-input v-model="Form.name"></el-input></el-form-item>
				<el-form-item prop="number" label="版权申请号"><el-input v-model="Form.number"></el-input></el-form-item>
				...
				<h1 class="form-type-title">版权摘要</h1>
				<el-form-item prop="msgOne" label="版权摘要">
	...
	methods: {
		submit() {
			this.$refs['Form'].validate(async valid => {
				if (valid) {
					let { code, data, msg } = await Api.setInsertCopyRightInfo(this.Form);
					if (code == 10200) {
