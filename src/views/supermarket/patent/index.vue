	...
	<div class="view ">
		<div class="banner limit-max-width-inset">
			...
			<el-form ref="Form" :model="Form" label-position="top" inline class="flex-center">
				<el-form-item prop="keyWord" label="专利名称"><el-input v-model="Form.keyWord" placeholder="请输入关键字" @blur="startGetTable()" clearable></el-input></el-form-item>
				...
				<el-form-item prop="createSort" label="专利排序" >
...
export default {
	...
	methods: {
		...
		async getTableData() {
			...
			let { code, data, msg } = await Api.selectPatentInfoList(params);
			if (code == 10200) {
